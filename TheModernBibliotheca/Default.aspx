<%@ Page Title="" Language="C#" MasterPageFile="~/Templates/Borrower.master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="TheModernBibliotheca.Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="display: flex">
        ...
        <div style="display: flex; margin-left: auto; justify-content: right; align-items: center;">
            ...
            <asp:Button ID="btnSearch" class="btn btn-secondary" Text="Search" runat="server"/>
        </div>
    </div>
    <br />
        ...
        <asp:Repeater ID="Repeater1" runat="server">
            <ItemTemplate>
                <div class="card col-3 m-5" style="width: 18rem">
                    <img class="card-img-top" src='<%# Eval("Cover")%>' alt="Card image cap" />
                    <div class="card-body">
                        <h5 class="card-title"><%# Eval("Title")%></h5>
                        <a href='Books?ID=<%# Eval("ID")%>' class="btn btn-primary">Details</a>
                    </div>
                </div>
            </ItemTemplate>
        </asp:Repeater>
