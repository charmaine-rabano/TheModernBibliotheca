...
namespace TheModernBibliotheca._Code.App.Librarian
{
    public class ReportOnshelfRepository
    {
        ...
        public static IEnumerable<ReportOnshelfModel> GetBooks()
        {
            ...
            return context.BookInstances.Where(e => e.InCirculation).Select(e => new ReportOnshelfModel
            {
        ...
        {
            var context = CreateDbContext();
            return context.BookInstances.Where(e => e.BookInformation.Genre == specificGenre && e.InCirculation).Select(e => new ReportOnshelfModel
            {
                InstanceID = e.InstanceID,
                ISBN = e.ISBN,
                Title = e.BookInformation.Title,
